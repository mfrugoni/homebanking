	...
	public CommandLineRunner initData(ClientRepository clientRepository,
		...
		return (args -> {
			...
			transactionRepository.save(trans6);
 			...
 			//Loans data:
			Loan loanHipotecario = new Loan("Mortgage loan", 500000, List.of(12, 24, 36, 48, 60));
			Loan loanPersonal = new Loan("Personal loan", 100000, List.of(6, 12, 24));
			Loan loanAutomotriz = new Loan("Car loan", 300000, List.of(6, 12, 24, 36));
			...
			Card melbaGoldDebit = new Card(melbaCardHolder, CardType.DEBIT, CardColor.GOLD, "5555 6666 7777 8888", "773", LocalDate.now(), LocalDate.now().plusYears(5), true);
			Card melbaTitaniumCredit = new Card(melbaCardHolder, CardType.CREDIT, CardColor.TITANIUM, "1212 3333 1029 3847", "182", LocalDate.now(), LocalDate.now().plusYears(5), true);

			String mikaCardHolder = client2.getFirstName() + " " + client2.getLastName();
			Card mikaSilverCredit = new Card(mikaCardHolder, CardType.CREDIT, CardColor.SILVER, "9201 8374 7566 0101", "555", LocalDate.now(), LocalDate.now().plusYears(4), true);
